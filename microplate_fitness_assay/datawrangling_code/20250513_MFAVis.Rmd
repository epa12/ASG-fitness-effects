...
#Box and Whiskers
BWLB24<-ggplot(subset(FEP24, Media == "LB") %>%
  ...
  facet_wrap(~Media)
ggsave("20250513_BWLB_24hr.png", plot=BWLB24, width = 10, height = 6, dpi = 300)
BWLB24


#Line plot
LPLB24<-ggplot(subset(FEP24, Media == "LB")%>%
...
ggsave("20250513_LPLB_24hr.png", plot=LPLB24, width = 10, height = 6, dpi = 300)
LPLB24
...
d<-ggplot(OD.long, aes(x = Time, y = OD600, colour = interaction(Media, Infection))) +
  ...
  facet_wrap(~Strain)
ggsave("20250513_Strains.png", plot = d, width = 6, height = 4, dpi = 300)
print(d)
...
ggsave("20250513_Infection.png", plot = s, width = 6, height = 4, dpi = 300)
print(s)
```
...
BWLB<-ggplot(subset(FEP, Media == "LB") %>%
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  facet_wrap(~Media)
ggsave("20250513_BWLB_48h.png", plot=BWLB, width = 10, height = 6, dpi = 300)
BWLB
...
LPLB<-ggplot(subset(FEP, Media == "LB")%>%
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        panel.border = element_rect(color = "black", fill = NA, size =  1))
ggsave("20250513_LPLB.png", plot=LPLB, width = 10, height = 6, dpi = 300)
LPLB
