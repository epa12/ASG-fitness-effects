...
FL.long <- data %>%
  pivot_longer(cols = -Time..Hours., names_to="Well", values_to="Fluorescence")
str(FL.long)
...
print(done)
```
If using Fluor to calc fitness
...
p<-ggplot(summary, aes(x = Time..Hours., y = Fluorescence, colour = interaction(Strain, Media, Infection)))+
  geom_line() +
...
m<-ggplot(summary, aes(x = Time..Hours., y = Fluorescence, colour = interaction(Strain, Infection)))+
  #geom_line() + 
  theme_minimal() + geom_smooth()+
...
d<-ggplot(summary, aes(x = Time..Hours., y = Fluorescence, colour = interaction(Media, Infection))) +
  #geom_line() +
  theme_minimal() + geom_smooth()+
...
s <- ggplot(summary, aes(x = Time..Hours., y = Fluorescence, colour = interaction(Strain, Media))) +
  theme_minimal() + 
  geom_smooth() +
